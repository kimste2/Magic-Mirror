...
def getWeather():
    ...
    fileName = "./config/config.txt" # use relative path and make own folder (config)
    ...
    apiParameter = "api.openweathermap.org/data/2.5/weather?zip=01773,us&appid="+ key + "&units=imperial"
